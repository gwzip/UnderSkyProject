...
namespace CombatSystem2D
{
    public class Entity : MonoBehaviour
    {
        ...
        public bool flipped;
        public bool swordInvincible; // Ensure entity gets damaged only once by the swing of the sword
        ...
        public void TakeDamage(DamageTaken damageTaken)
        {
            ...
            // Knockback
            if (damageTaken.knockback > 0) StartCoroutine(Knockback(damageTaken.knockback, damageTaken.knockbackDirection));
